...
set(linker_script_SRC ${linker_script_SRC}
    ${CMAKE_CURRENT_SOURCE_DIR}/stm32f302r8tx_FLASH.ld
)
...
set(sources_SRCS ${sources_SRCS}
	...
	${CMAKE_CURRENT_SOURCE_DIR}/Src/tarvs_f302x8_sysclk.c	
	${CMAKE_CURRENT_SOURCE_DIR}/Src/tarvs_f302x8_gpio.c
	${CMAKE_CURRENT_SOURCE_DIR}/Src/tarvs_f302x8_delay.c
	${CMAKE_CURRENT_SOURCE_DIR}/Startup/startup_stm32f302r8tx.s
)
